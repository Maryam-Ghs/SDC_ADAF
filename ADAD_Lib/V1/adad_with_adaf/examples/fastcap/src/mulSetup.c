...
*/
static void set_vector_masks(sys)
ssystem *sys;
{
  int i;
  cube *cp;
...
*/
static void indexkid(sys, dad, pqindex, pcindex)
ssystem *sys;
cube *dad;
int *pqindex, *pcindex;
{
...
*/
static void placeqold(sys, charges)
ssystem *sys;
charge *charges;
{
double length;
